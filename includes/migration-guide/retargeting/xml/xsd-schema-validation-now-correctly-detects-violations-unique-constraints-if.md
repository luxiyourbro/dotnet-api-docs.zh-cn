### <a name="xsd-schema-validation-now-correctly-detects-violations-of-unique-constraints-if-compound-keys-are-used-and-one-key-is-empty"></a>XSD 架构验证现在，如果使用复合键且有一个键为空正确检测违反唯一约束的情况
